    ...
    return (
        <View style={styles.container}>
            <View style={styles.buttonContainer}>
                ...
                <TouchableOpacity style={[styles.button, { backgroundColor: '#085D7A' }]}>
                    <Text style={[style.h4, { color: '#FFFFFF' }]}>Accept</Text>
                </TouchableOpacity>
            </View>
            <ScrollView showsVerticalScrollIndicator={false} style={{ padding: 15 }}>

                <Text style={[style.h2, { color: 'black' }]}>{"\n"}Privacy Policy{"\n"}</Text>
                <Text style={[style.h5, { color: 'black' }]}>PT. Telkom Corporate University (“kami”) berkomitmen untuk menjaga kerahasiaan dan keamanan informasi pribadi Anda. Kami membuat kebijakan Privasi ini agar Anda memahami cara kami mengumpulkan, menggunakan, dan membagikan data tentang Anda.
                    {"\n"}{"\n"}
                    Kebijakan Privasi ini mengatur landasan dasar mengenai bagaimana kami menggunakan informasi pribadi yang kami kumpulkan dan/atau Anda berikan (“Informasi Pribadi”). Kebijakan Privasi ini berlaku bagi seluruh pengguna layanan, kecuali diatur pada kebijakan privasi yang terpisah. Mohon membaca kebijakan Privasi kami dengan seksama sehingga Anda dapat memahami pendekatan dan cara kami dalam menggunakan informasi tersebut.
                    {"\n"}{"\n"}
                ...
                <Text style={[style.h4medium, { color: 'black' }]}>1. Data Apa yang kami dapatkan</Text>
                <Text style={[style.h5, { color: 'black' }]}>Kami mengumpulkan data tertentu dari Anda secara langsung, seperti informasi yang Anda masukkan sendiri. Kami juga mengumpulkan sebagian data secara otomatis sesuai dengan layanan yang terhubung dengan Google Analytics.{"\n"}{"\n"}
                ...
                <Text style={[style.h5, { color: 'black' }]}>- Data Akun
                    {"\n"}
                    Untuk dapat menggunakan fitur yang ada pada aplikasi Ideabox, Anda perlu login menggunakan SSO. Kami akan mengumpulkan dan menyimpan data yang Anda berikan, seperti nama lengkap, gambar profil, jenis kelamin, bahasa yang dipilih, informasi lain yang dibuat publik dan alamat email. {"\n"}
                </Text>
                <Text style={[style.h5, { color: 'black' }]}>- Data Profil
                    {"\n"}
                    Anda juga dapat memilih untuk menyediakan informasi profil seperti foto, nama lengkap, alamat email, nama pengguna (username), role, dan beberapa informasi lainnya. Data Profil Anda dapat dilihat secara terbuka oleh pihak lain.
                    {"\n"}

                </Text>
                <Text style={[style.h5, { color: 'black' }]}>
                    B. Data yang Kami Kumpulkan melalui Cara Otomatis
                    {"\n"}
                    {"\n"}
                    Kami menggunakan layanan Google Analytics yang secara otomatis mengumpulkan data tertentu mencakup data sistem, data penggunaan, dan perkiraan data geografis.
                    {"\n"}
                </Text>
                <Text style={[style.h4medium, { color: 'black' }]}>2. Untuk Apa Data Anda Digunakan
                </Text>
                <Text style={[style.h5, { color: 'black' }]}>
                ...
                <Text style={[style.h4medium, { color: 'black' }]}>3. Bagaimana Kami Membagikan dan Mengungkapkan Informasi Anda
                </Text>
                <Text style={[style.h5, { color: 'black' }]}>
                    Kami menggunakan data Anda untuk melakukan hal-hal seperti menyediakan Layanan kami, berkomunikasi dengan Anda, memecahkan masalah, melindungi dari penipuan dan penyalahgunaan, meningkatkan mutu dan memperbarui Layanan kami, menganalisis cara orang menggunakan Layanan kami, menyajikan iklan yang dipersonalisasi, dan sebagaimana disyaratkan oleh hukum atau diperlukan untuk keamanan dan integritas.
                    {"\n"}
                </Text>
                <Text style={[style.h4medium, { color: 'black' }]}> 4. Hak Anda
                </Text>
                <Text style={[style.h5, { color: 'black' }]}>
                ...
                <Text style={[style.h4medium, { color: 'black' }]}>5. Kebijakan Cookies
                </Text>
                <Text style={[style.h5, { color: 'black' }]}>
                    Ketika Anda menggunakan Layanan, Kami dapat menempatkan sejumlah cookies pada browser Anda. Cookies adalah sebuah berkas digital kecil berisi huruf dan angka yang Kami simpan pada browser atau hard drive komputer Anda atas persetujuan Anda. Cookies mengandung informasi yang dipindahkan ke diska keras komputer Anda.
                    {"\n"}{"\n"}
                    ...
                    {"\n"}{"\n"}
                    Cookies dibutuhkan untuk pengoperasian Platform Kami. Ini termasuk, misalnya, Cookies yang memungkinkan Anda memasuki Area yang aman di Platform Kami, menggunakan keranjang belanja, ataupun menggunakan layanan penagihan eletronik.
                    Cookies memungkinkan Kami untuk mengenali dan menghitung jumlah pengunjung serta melihat bagaimana pengunjung bergerak di sekitar Platform Kami saat mereka menggunakannya. Ini membantu Kami memperbaiki cara kerja Platform Kami, misalnya, dengan memastikan pengguna menemukan apa yang mereka cari dengan mudah.
                    Cookies digunakan untuk mengenali Anda saat kembali ke Platform Kami. Ini memungkinkan Kami melakukan personalisasi terhadap konten Kami untuk Anda, menyapa Anda dengan nama, serta mengingat preferensi Anda (misalnya, pilihan bahasa atau wilayah Anda).
                ...
                <Text style={[style.h4medium, { color: 'black' }]}>6. Pengakuan dan Persetujuan
                </Text>
                <Text style={[style.h5, { color: 'black' }]}>
                ...
                <Text style={[style.h4medium, { color: 'black' }]}>7. Perubahan atas kebijakan Privasi Kami
                </Text>
                <Text style={[style.h5, { color: 'black' }]}>
                    Dari waktu ke waktu, kami dapat memperbarui Kebijakan Privasi ini. Jika kami membuat perubahan yang mendasar, kami akan memberi tahu Anda melalui email, melalui pemberitahuan yang diunggah di Layanan, atau sebagaimana yang diwajibkan oleh hukum yang berlaku. Kami juga akan menyertakan ringkasan perubahan utama. Kecuali dinyatakan lain, perubahan akan berlaku efektif pada hari pemberitahuan tersebut diunggah.
                    {"\n"}{"\n"}
